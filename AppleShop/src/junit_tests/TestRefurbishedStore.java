...
public class TestRefurbishedStore {
	...
	@Test
	public void test_refrubished_store_1() {
		...
		Product p1 = new Product("iPad Pro", 1709.00);
		...
		p2.setHasCellularConnectivity(true);
		p1.setDiscountValue(100.00);
		Entry e2 = new Entry("C9FZN4J8QC82", p2);
		// Add entry 2
		rs.addEntry(e2);
	...
	@Test
	public void test_refrubished_store_2() {
		// Create an empty store
		RefurbishedStore rs = new RefurbishedStore(); // max 5 entries
		...
		rs.getProduct("7YM4PFZ779UB").setStorage(256); // 256 GB
	...
	@Test
	public void test_refrubished_store_3() {
		// Create an empty store
		RefurbishedStore rs = new RefurbishedStore(); // max 5 entries
		...
		assertTrue(rs.getSpaceGreyOrPro()[0].equals("F9FDN4NKQ1GC") && rs.getSpaceGreyOrPro()[1].equals("7YM4PFZ779UB"));
